...
class UserProfileController extends GetxController{
  ...
  getUserProfileData()async{
    ...
    try{
      final response  = await NetworkCaller().getRequest(ApiEndPoints.getUserProfile,token:token );
      if(response.isSuccess){
        ...
        getUserProfile.value = getdata.image??"https://cdn-icons-png.flaticon.com/512/180/180644.png";
