...
class EditUserProfileModel {
  ...
  final EditUserProfileModelData? data;
  ...
  factory EditUserProfileModel.fromJson(Map<String, dynamic> json) => EditUserProfileModel(
    ...
    data: json["data"] == null ? null : EditUserProfileModelData.fromJson(json["data"]),
  );
...
class EditUserProfileModelData {
  final String? id;
  final String? name;
  final String? image;
  final String? email;
  ...
  factory EditUserProfileModelData.fromJson(Map<String, dynamic> json) => EditUserProfileModelData(
    id: json["id"],
    name: json["name"],
    image: json["image"],
    email: json["email"],
