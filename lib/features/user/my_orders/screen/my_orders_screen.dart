...
import 'package:sandlink/core/widgets/custom_button.dart';
import 'package:sandlink/core/wrappers/custom_text.dart';
import 'package:sandlink/features/user/my_orders/controllers/my_orders_controllers.dart';
import 'package:sandlink/features/user/my_orders/screen/track_order_screen.dart';
import 'user_item_reviews.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          CustomText(
                            text: order.invoiceId ?? "Unknown ID",
                            color: AppColors.blackColor,
                            fontWeight: FontWeight.w500,
                            fontSize: 16.sp,
                          ),
                      ...
                      // shop name
                      CustomText(
                        text: "Shop: ${order.seller?.shopName ?? 'Unknown'}",
                        color: AppColors.blackColor,
                        fontWeight: FontWeight.w400,
                        fontSize: 14.sp,
                      ),
                      ...
                      SizedBox(height: 12.h),
                      Divider(color: AppColors.geryColorE4),
                        ...
                        children: [
                          ...
                          Flexible(
                            child: CustomButton(
                              ...
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w500,
                              backgroundColor: order.status == "PLACED"
                                  ? AppColors.blackColor
                                  : AppColors.greenColor,
                            ),
                          ),
