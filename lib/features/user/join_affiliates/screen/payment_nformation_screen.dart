...
class PaymentNformationScreen extends StatelessWidget {
  const PaymentNformationScreen({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: [
                              ...
                              CustomText(
                                text:
                                    'Setup your payment method for withdrawals',
                        ...
                        Container(
                          ...
                          width: double.infinity.w,
                          decoration: BoxDecoration(
                            color: AppColors.blueColor49.withValues(alpha: 0.2),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomText(
                                  ...
                                  text:
                                      'This information will be used to transfer your earnings, Make sure the details are accurate.',
                                  color: AppColors.lightGrey,
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.w500,
                                ),
