...
import '../controller/rider_phone_verification_controllers.dart';

class RiderPhoneVerificationScreens extends StatelessWidget {
  RiderPhoneVerificationScreens({super.key});

   final controller = Get.put(RiderPhoneVerificationController());
